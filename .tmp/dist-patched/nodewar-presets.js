...
export const WAR_DAYS = ["sunday", "monday", "tuesday", "wednesday", "thursday", "friday"];
export const OPTIONAL_ROLE_PRESETS = [
...
export function getNodeWarCapacity(tier, day) {
...
export function getT1DefaultGroups(totalCapacity) {
    const defense = 5;
    const zerker = 2;
    const shai = 2;
...
export function getGroupsForPreset(tier, totalCapacity) {
    if (tier === "tier1") {
...
export function buildNodeWarTitle(day, tier, totalCapacity) {
...
export function labelWarDay(day) {
    if (!day) {
        return "Custom";
    }
