...
export const eventCommand = new SlashCommandBuilder()
    ...
    .setRequired(true)
    .addChoices({ name: "Sunday", value: "sunday" }, { name: "Monday", value: "monday" }, { name: "Tuesday", value: "tuesday" }, { name: "Wednesday", value: "wednesday" }, { name: "Thursday", value: "thursday" }, { name: "Friday", value: "friday" }, { name: "Saturday", value: "saturday" }))
    .addStringOption((option) => option
    .setName("time")
    ...
    .addStringOption((option) => option.setName("id").setDescription("Event ID").setRequired(true))
    .addIntegerOption((option) => option.setName("def").setDescription("Defense slots").setRequired(true).setMinValue(0).setMaxValue(200))
    .addIntegerOption((option) => option.setName("zerk").setDescription("Zerker slots").setRequired(true).setMinValue(0).setMaxValue(200))
    .addIntegerOption((option) => option.setName("shai").setDescription("Shai slots").setRequired(true).setMinValue(0).setMaxValue(200)))
    .addSubcommand((subcommand) => subcommand
    .setName("recurring")
