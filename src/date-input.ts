import type { Recurrence, WarDay } from "./types.js";
...
export function parseEventDateInput(input: string, now = new Date()): ParsedDateInput {
...
export function getNextWarDate(day: WarDay, now = new Date()): string {
